        ...
        <div class="row">
            ...
            <div
                ...
                <ul class="m-0 p-0 d-flex social-link">
                    <li>
                        <a href="#" class="d-block position-relative"><i class="bi bi-facebook"></i></a>
                    </li>
                    <li>
                        <a href="#" class="d-block position-relative"><i class="bi bi-twitter"></i></a>
                    </li>
                    <li>
                        <a href="#" class="d-block position-relative"><i class="bi bi-instagram"></i></a>
                    </li>
                    <li>
                        <a href="#" class="d-block position-relative"><i class="bi bi-linkedin"></i></a>
                    </li>
                </ul>
            </div>
        </div>
