...
<main class="hero-section position-relative">
    <div class="custom-container">
        <div class="hero-text position-absolute top-50">
            <h1 class="m-0">Explore No. 1<br> WordPress themes</h1>
            <p>10+ Home Pages With Eye Catching Inner Pages. Over 80+ interface <br> elements, 10 different Live demo
                pages.</p>
            <a href="#" class="primary-btn d-flex align-items-center gap-2">Explore now <i
...
<section class="feature-section section-pad">
    <div class="custom-container-sm">
        ...
        <div class="row">
            <div class="col-md-6">
                <div
                    class="feature-card mx-auto text-center d-flex flex-column align-items-center justify-content-center">
                    <figure class="feature-icon">
